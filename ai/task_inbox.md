...
- Roadmap content was normalized into `ai/tasks.md`, `ai/project_state.md`, and `ai/context.md`
- Keep this file for rough capture only; duplicates and incomplete items are acceptable

## Raw Items

- Verify whether hydrated state should be sanitized or rejected when shape is invalid.
